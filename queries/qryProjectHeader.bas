...
dbLongBinary "DOL" = Begin
    0x0acc0e550000000035f87d9f0b136040ad3c2851f16d2a8000000000ba0a506d ,
    0xcedae4400000000000000000640062006f005f00500072006f006a0065006300 ,
    0x7400480065006100640065007200000000000000000000000000000000000000 ,
    0x000000000c000000050000000000000000000000000000000000
End
dbBinary "GUID" = Begin
    0xc8deecf14885454ea3560c5d5f067da9
End
Begin
    Begin
    ...
    End
    Begin
        dbText "Name" ="dbo_ProjectHeader.GSTExempt"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="dbo_ProjectHeader.CODApprovedYN"
        dbLong "AggregateType" ="-1"
    End
    Begin
    ...
    End
    Begin
        dbText "Name" ="dbo_ProjectHeader.UnitPriceYN"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="dbo_ProjectHeader.QuoteTotalsYN"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="dbo_ProjectHeader.CustomerPickupYN"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="dbo_ProjectHeader.PurchaserID"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="dbo_ProjectHeader.PostToAcc"
        dbLong "AggregateType" ="-1"
    End
    Begin
    ...
    End
    Begin
        dbText "Name" ="dbo_ProjectHeader.PostToResult"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="dbo_ProjectHeader.CODPaidDate3"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="dbo_ProjectHeader.CODPaidDate5"
        dbLong "AggregateType" ="-1"
    End
    Begin
    ...
    End
    Begin
        dbText "Name" ="dbo_ProjectHeader.PostToAccDate"
        dbLong "AggregateType" ="-1"
    End
    Begin
    ...
    End
    Begin
        dbText "Name" ="dbo_ProjectHeader.CODPaidAmt3"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="dbo_ProjectHeader.CODPaidAmt5"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="dbo_ProjectHeader.CODTotalDue"
        dbLong "AggregateType" ="-1"
    End
    Begin
    ...
    End
    Begin
        dbText "Name" ="dbo_ProjectHeader.ShipBillThirdParty"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="dbo_ProjectHeader.CODPaidDate2"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="dbo_ProjectHeader.CODPaidDate4"
    ...
    End
    Begin
        dbText "Name" ="dbo_ProjectHeader.CODPaidDate1"
        dbLong "AggregateType" ="-1"
    End
    Begin
    ...
    End
    Begin
        dbText "Name" ="dbo_ProjectHeader.ShipBillThirdPartyName"
        dbLong "AggregateType" ="-1"
    End
    Begin
    ...
    End
    Begin
        dbText "Name" ="dbo_ProjectHeader.CODPaidAmt2"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="dbo_ProjectHeader.CODPaidAmt4"
        dbLong "AggregateType" ="-1"
    End
    Begin
    ...
    End
    Begin
        dbText "Name" ="dbo_ProjectHeader.CODPaidAmt1"
        dbLong "AggregateType" ="-1"
    End
End
Begin
