...
Begin Form
    ...
    End
    GUID = Begin
        0xaf84eaa19f75c8428cb458e46283fd7f
    End
    NameMap = Begin
        0x0acc0e55000000006d153b30f0f27a4faa7b8bd5b3f93a5702000000a45c7dd6 ,
        0x2c75e4400000000000000000720070007400570049005000420069006e006400 ,
    ...
    PrtDevModeW = Begin
        0x0000fffff49b030101000000000000004800000084c7030109000000f5c4fc2f ,
        0x50174b06789d03011b000000010000006002bd1800000000240000003c9d0300 ,
        0x01040300dc00340343ff800701000100ea0a6f08000001000301580202000100 ,
        0x580202000100000038c703001b000000760000000000bd18e09f03014566b277 ,
        0x700976dffeffffffb89c0301d306ae77feffffff480000001b00000050174b06 ,
...
If Nz(Me.frmShowOnly, 0) <> 0 Then
    ...
    Case 1 'Trim
        myfilter = myfilter & " WHERE [IsTrim] = True"
    
    Case 2 'Pad
        myfilter = myfilter & " WHERE [PadInYN] = true"
    
    Case 3 'Drill
        myfilter = myfilter & " WHERE [DrillYN] = true"
    
    Case 4 'Score
        myfilter = myfilter & " WHERE [IsScore] = true"
        
    Case 5 'Fold
        myfilter = myfilter & " WHERE [FoldYN] = true"
        
    Case 6 'Saddle Stitch
        myfilter = myfilter & " WHERE [BindSaddleYN] = true"
        
    Case 7 'Perfect Bind
        myfilter = myfilter & " WHERE [BindPerfectYN] = true"
        
    Case 8 'Coil Bind
        myfilter = myfilter & " WHERE [BindCoilYN] = true"
        
    Case 9 'Wire-O
        myfilter = myfilter & " WHERE [BindWireOYN] = true"
